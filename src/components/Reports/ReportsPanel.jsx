  ...
  return (
    <div className="bg-white/90 backdrop-blur-md border border-blue-200 rounded-2xl h-full flex flex-col shadow-lg">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {reports.map((report) => {
          const severity =
            severityConfig[report.severity] || severityConfig.low;
          ...
          return (
            <div
              ...
              className={`border rounded-2xl p-4 transition-all cursor-pointer ${
                isActive
                  ...
                  : "border-blue-200 bg-white/80 hover:bg-blue-50/50 hover:shadow-md"
              }`}
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <span
                  className={`text-xs px-3 py-1 rounded-full border font-medium ${severity.color}`}
                >
                  {severity.label}
                </span>
              </div>
              ...
              <p className="text-blue-800 text-sm mb-4 overflow-hidden text-ellipsis">
                {report.description}
              </p>
